...
describe("Test handleGetRequest", () => {
  ...
  it("should handle missing use-case id", async () => {
    test_rejection_if_missing_use_case_id(ddbMock, handleGetRequest);
  });
...
describe("Test handlePutRequest", () => {
  ...
  it("should handle missing use-case id", async () => {
    test_rejection_if_missing_use_case_id(ddbMock, handlePutRequest);
  });
...
describe("Test handleDeleteRequest", () => {
  ...
  it("should handle missing use-case id", async () => {
    test_rejection_if_missing_use_case_id(ddbMock, handleDeleteRequest);
  });
